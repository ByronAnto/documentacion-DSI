...
El valor a ingresar dependerá de la cantidad de presas incluidas en el Plu seleccionado (**Ejem:** “10 PRESAS KFC (Salón)” el valor a ingresar es 10).
...
|----|-----------|-----------|----------------------------------------------------|-------------------------------------------------------|
| 1  | SEPARADOR | Carácter  | ORIGINAL,CRISPY                                   | Carácter utilizado para separar las presas            |
| 2  | SEPARADOR | Decimal   | Porcentaje Min y Max de acuerdo a la distribución | Porcentaje mínimo y máximo para la distribución deseada|
...
| N° | Colección                                  | Descripción                                                                                                       |
|----|--------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| 1  | VISUALIZAR CANTIDAD DE PRODUCTOS CON PRECIO 0 | Colección que permite visualizar los ítems con valor 0 en la ventana de orden de pedido y en el ticket de la orden. |
