# MANUAL DE CONFIGURACION DE NOTA DE CREDITO FIDELIZACION DE SERVICIO V2 CADENA
...
|----|-------------------|--------------------------------------|------------|-------------|-----------|
| 1  | WS RUTA SERVICIO | FIREBASE CREDITOSACUMULACIONPUNTOS  | SI         | SI          | CARACTER  |
| 2  | WS RUTA SERVICIO | FIREBASE CREDITOSALDO                | SI         | SI          | CARACTER  |
